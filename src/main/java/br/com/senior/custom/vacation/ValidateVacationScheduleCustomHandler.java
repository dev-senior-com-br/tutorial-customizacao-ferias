...
public class ValidateVacationScheduleCustomHandler {
    ...
    private void validate(ValidateVacationScheduleOutput output, VacationSchedule vacationSchedule) {
        ...
        System.out.println("******AllCustomField: "+Double.parseDouble(vacationPolicy.getCustom("maxDayToRequestVacation").toString()));
        if (vacationSchedule.startDate.getDayOfMonth() > Double.parseDouble(vacationPolicy.getCustom("maxDayToRequestVacation").toString())) {
